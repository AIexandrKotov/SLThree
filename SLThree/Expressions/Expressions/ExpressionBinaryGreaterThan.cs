...
namespace SLThree
{
    public class ExpressionBinaryGreaterThan : ExpressionBinary
    {
        ...
        public ExpressionBinaryGreaterThan(BaseExpression left, BaseExpression right, SourceContext context, bool priority = false) : base(left, right, context, priority) { }
