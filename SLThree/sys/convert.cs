...
#pragma warning disable IDE1006 // Стили именования
    public static class convert
    {
        ...
        public static long fbin(string str) => Convert.ToInt64(str.Trim().Replace("0b", "").Replace("_", ""), 2);
        public static long foct(string str) => Convert.ToInt64(str.Trim().Replace("0o", "").Replace("_", ""), 8);
        public static long fhex(string str) => Convert.ToInt64(str.Trim().Replace("0x", "").Replace("_", ""), 16);
        public static long from(string str)
        {
            var trimmed = str.Trim().Replace("_", "");
