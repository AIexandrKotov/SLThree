    ...
    public sealed class TemplateMethod : Method
    {
        ...
        public class FunctionConstraintDefinition : ConstraintDefinition
        {
            ...
            public override Constraint GetConstraint(string current_template, ExecutionContext context)
            {
                ...
                return new FunctionConstraint(new Method("constraint", new string[1] { current_template }, new StatementList(new BaseStatement[1] { st }, st.SourceContext), new TypenameExpression[1], null, context.wrap, true, false, true, new BaseExpression[0], new bool[1], null), SourceContext.CloneCast());
            }
        ...
        {
            return new TemplateMethod(name, ParamNames?.CloneArray(), OriginalStatements.CloneCast(), OriginalParamTypes.CloneArray(), OriginalReturnType.CloneCast(), definitionplace, Implicit, Recursive, WithoutParams, OriginalDefaultValues.CloneArray(), ContantsParams.Copy(), mode, Generics.ConvertAll(x => (x.Item1.CloneCast(), x.Item2.CloneCast())))
            {
                Abstract = Abstract
            };
        }
